DROP TABLE PUBLIC.PLANNED_GAME IF EXISTS;
DROP TABLE PUBLIC.TABLE_MESSAGE IF EXISTS;
...
CREATE MEMORY TABLE PUBLIC.PLANNED_GAME(ID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,RPG_TABLE INTEGER NOT NULL,GAME_START TIMESTAMP NOT NULL,GAME_END TIMESTAMP NOT NULL,TITLE VARCHAR(255) NOT NULL,CONSTRAINT PLANNED_GAME_TABLE FOREIGN KEY(RPG_TABLE) REFERENCES PUBLIC.RPG_TABLE(ID));
